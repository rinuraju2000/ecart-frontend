...
//Api function to get all products from the database
  ...
  //Add to cart
  addToCart(product:any){//Product is an object
  ...
  deleteCartProduct(id:any){
    return this.http.delete(`${this.BASE_URL}/carts/delete-cart/${id}`)
  }
